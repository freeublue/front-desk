...
additions<input type='text' name='sum' value='$sum' /><br />
grandtotal<input type='text' name='grandtotal' value='$tot' /><br />
salestax<input type='text' name='salestax' value='$salestax' /><br />
